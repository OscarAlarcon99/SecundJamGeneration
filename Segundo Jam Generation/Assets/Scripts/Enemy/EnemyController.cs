...
public class EnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        if (agent.remainingDistance <= agent.stoppingDistance && !agent.pathPending  )
        {
            ...
            m_animator.SetFloat("Forward", 3); // enemy walk
            m_animator.SetFloat("Forward2", 2); // enemy walk
            Ended();
        }
        //PPRUEBA DE MUERTE
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {       
            ...
            m_animator.SetFloat("Forward", 4); // Enemy attack
            m_animator.SetFloat("Forward2", 3); // Enemy attack
